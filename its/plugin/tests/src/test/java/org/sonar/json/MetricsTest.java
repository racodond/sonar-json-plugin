...
public class MetricsTest {
  ...
  public void project_measures() {
    assertThat(getProjectMeasure("lines").getIntValue()).isEqualTo(19);
    assertThat(getProjectMeasure("ncloc").getIntValue()).isEqualTo(13);
    assertThat(getProjectMeasure("classes").getIntValue()).isEqualTo(7);
    assertThat(getProjectMeasure("functions")).isNull();
    assertThat(getProjectMeasure("statements").getIntValue()).isEqualTo(18);
  ...
  public void dir_measures() {
    assertThat(getDirMeasure("lines").getIntValue()).isEqualTo(10);
    assertThat(getDirMeasure("ncloc").getIntValue()).isEqualTo(7);
    assertThat(getDirMeasure("classes").getIntValue()).isEqualTo(4);
  ...
  public void file1_measures() {
    assertThat(getFile1Measure("lines").getIntValue()).isEqualTo(9);
    assertThat(getFile1Measure("ncloc").getIntValue()).isEqualTo(6);
    assertThat(getFile1Measure("classes").getIntValue()).isEqualTo(3);
    assertThat(getFile1Measure("functions")).isNull();
    assertThat(getFile1Measure("statements").getIntValue()).isEqualTo(7);
  ...
  public void file2_measures() {
    assertThat(getFile2Measure("lines").getIntValue()).isEqualTo(10);
    assertThat(getFile2Measure("ncloc").getIntValue()).isEqualTo(7);
    assertThat(getFile2Measure("classes").getIntValue()).isEqualTo(4);
  ...
  private Measure getFile1Measure(String metricKey) {
    return getFileMeasure(metricKey, PROJECT_KEY + ":src/file1.json");
  }

  private Measure getFile2Measure(String metricKey) {
    return getFileMeasure(metricKey, PROJECT_KEY + ":src/dir/file2.json");
  }
