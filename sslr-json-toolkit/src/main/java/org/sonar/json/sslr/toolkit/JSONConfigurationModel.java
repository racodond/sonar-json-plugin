 ...
 */
package org.sonar.json.sslr.toolkit;
...
public class JSONConfigurationModel extends AbstractConfigurationModel {

  private static final Logger LOG = LoggerFactory.getLogger(JSONConfigurationModel.class);
  ...
  public Parser doGetParser() {
    return new ParserAdapter<LexerlessGrammar>(getCharset(), JSONGrammar.createGrammar());
  }
  ...
  JSONConfiguration getConfiguration() {
    return new JSONConfiguration(getCharset());
  }
